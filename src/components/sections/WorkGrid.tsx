    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {CASE_STUDIES.map((study, index) => (
        ...
        >
          ...
          />
          <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            ...
            >
              View Case Study <ArrowUpRight className="w-4 h-4 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1" />
            </Link>
          </div>
          
          {/* Static Overlay for Mobile/Initial */}
